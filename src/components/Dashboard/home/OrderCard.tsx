              ...
              >
                <div className="relative">
                  <img 
                    ...
                    className="w-12 h-12 sm:w-14 sm:h-14 rounded-full object-cover border-2 border-gray-100 flex-shrink-0 group-hover:border-amber-300 transition-colors duration-200"
                  />
