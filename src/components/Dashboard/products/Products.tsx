...
const Products = () => {
  ...
  return (
    <div className="w-full min-h-screen p-8">
      <div className="w-full flex items-center justify-between mb-8 mt-8">
        <h1 className="text-2xl font-bold md:text-4xl ">Manage Products</h1>
        <Button className="text-md bg-amber-600 hover:bg-amber-500 cursor-pointer hover:scale-95 shadow-[0_0_5px] shadow-amber-400 font-bold p-5"><Plus />Add Product</Button>
      </div>
